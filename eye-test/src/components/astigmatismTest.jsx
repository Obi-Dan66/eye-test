      ...
      case 0:
        return (
            <div>
                ...
                <img className= "astigmatism-image" src='src\assets\12.svg' width={200} height={200} alt="color test"></img>
                <div>
                <button className='colorTestBtn correct' onClick={() => handleClick(true)}>Ano</button>
                <button className='colorTestBtn' onClick={() => handleClick(false)}>Ne</button>
              </div>
            </div>
        </div>);
      case 1:
