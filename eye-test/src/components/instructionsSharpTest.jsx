  ...
  const getContent = (contentIndex) => {
    switch (contentIndex) {
      ...
      case 6:
        ...
        <div>
        <img className= "circle-image" src='src\assets\circle.jpg' width={200} height={200} alt="circle"></img>
        </div>
                <h1>Označte bod. Vidite horní kruh? Označte příslušný výřez na spodním obrazci.</h1>
                <button className = 'defaultButton' onClick={startTest}>Začít test ostrosti zraku</button>
        </div>);
      default:
        return null;
    }
