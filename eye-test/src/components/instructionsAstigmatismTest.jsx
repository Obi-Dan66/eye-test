...
const InstructionsAstigmatismTest = () => {
    ...
    switch (contentIndex) {
      ...
      case 6:
        ...
        <img className= "circle-image" src='src\assets\circle.jpg' width={200} height={200} alt="circle"></img>
                ...
                <h1>Označte bod. Vidite horní kruh? Označte příslušný výřez na spodním kruhu.</h1>
...
export default InstructionsAstigmatismTest;